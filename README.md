...
git branch -M main
git remote add origin https://github.com/umr-lops/unifiedwvalticolocs.git
...
```bibtex
@misc{unifiedwvalticolocs,
  author = {umr-lops},
  title = {lib python to generate colocs S1 WV with CMEMS or CCI seatstate altimeters},
  year = {2026},
  publisher = {GitHub},
  journal = {GitHub repository},
  howpublished = {\url{https://github.com/umr-lops/unifiedwvalticolocs}}
}
```
