# Docker for unifiedwvalticolocs
...
Default name is `IMAGE := unifiedwvalticolocs`.
Default version is `VERSION := latest`.

```bash
make docker-build IMAGE=some_name VERSION=2026.1.27
```
...
```bash
make docker-remove VERSION=2026.1.27
```
